...
const CACHE_NAME = 'tetris-v3.3.4';
const CACHE_VERSION = 'v3.3.4';
const API_CACHE = 'tetris-api-v3.3.4';
const AUDIO_CACHE = 'tetris-audio-v3.3.4';
const AUTH_CACHE = 'tetris-auth-v3.3.4';
const PROGRESSION_CACHE = 'tetris-progression-v3.3.4';
const DAILY_CACHE = 'tetris-daily-v3.3.4';
